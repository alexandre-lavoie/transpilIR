    ...
    return struct {
        ...
        fn comparison(self: *Self, data_type: ast.StatementIndex) !ast.StatementIndex {
            ...
            const operation_type: ast.ComparisonOperationType = switch (self.previous.token_type) {
                ...
                .double_not_nan, .single_not_nan => .not_nan,
                .double_any_nan, .single_any_nan => .any_nan,
                else => return error.InvalidComparison,
            };

            const primitive_type: ast.PrimitiveType = switch (self.previous.token_type) {
                .double_equal, .double_not_equal, .double_greater_than_equal, .double_greater_than, .double_less_than_equal, .double_less_than, .double_not_nan, .double_any_nan => .f64,
                ...
                .single_equal, .single_not_equal, .single_greater_than_equal, .single_greater_than, .single_less_than_equal, .single_less_than, .single_not_nan, .single_any_nan => .f32,
